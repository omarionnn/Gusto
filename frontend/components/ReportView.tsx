      ...
      {(report as any).aiSummary && (
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-900">AI Website Analysis</h2>
          ...
          <div className="prose prose-sm max-w-none text-gray-700 bg-white rounded-lg p-4">
            <div className="whitespace-pre-wrap">{(report as any).aiSummary.summary}</div>
          </div>
          <div className="mt-3 flex items-center text-xs text-gray-600">
            <span>📸 Analyzed {(report as any).aiSummary.screenshotCount} screenshots</span>
            <span className="mx-2">•</span>
            <span>Generated: {new Date((report as any).aiSummary.generatedAt).toLocaleString()}</span>
          </div>
        </div>
      )}
